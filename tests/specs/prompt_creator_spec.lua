...
describe("clodex.ui.prompt_creator", function()
    ...
    it("highlights the selected target project in the project picker", function()
        ...
        assert.is_false(vim.tbl_contains(initial_groups, "ClodexPromptSourceTabActive"))
        assert.is_true(vim.tbl_contains(initial_groups, "ClodexPromptBugTitleActive"))
        ...
        assert.is_false(vim.tbl_contains(groups, "ClodexPromptBugTitleActive"))
    end)
    ...
    it("adds panel background margin around the creator with extra right and bottom space", function()
        ...
        assert.are.equal("ClodexPromptBackgroundOverlay", creator.project_bg_win.opts.theme_overrides.normal)
        assert.are.equal("ClodexPromptBackgroundOverlay", creator.project_bg_win.opts.theme_overrides.normal_float)
        assert.are.equal("ClodexPromptBackgroundOverlay", creator.project_bg_win.opts.theme_overrides.end_of_buffer)
